...
#### 4.Các sử dụng git
* Truy cập vào trang chủ [GitHub](https://github.com/).Sau đó tạo một tài khoản GitHub.
* Tiếp theo sẽ cài đặt git trên máy tính. Ta sẽ truy cập vào đường link này [Git](https://git-scm.com/downloads) để thực hiền download git về máy.
##### 5.Các câu lệnh sử dụng trong git
* lệnh **cd**:là câu lệnh dùng để di chuyển vào thư mục cần thao tác. khi muốn di chuyển đến 
![](/)
